    ...
    public sealed partial class MainPage : Page, INotifyPropertyChanged, IMemoryButtonHandler, IShare, IDoAppearance, IGetAppDetails, ICalculator, IObjectValue, IDoBack, IDoStopProgram
    {
        ...
        public MainPage()
        {
            try
            {
                ...
                Log.WriteWithTime("MainPage: doing: aps\r\n");
                ...
                testResult += Edit.ParserTest.Test(); //TODO: should not be enable in RELEASE mode
                if (testResult == 0)
                {
...
#if BLUETOOTH
            {
                ...
                this.Loaded += (s, e) =>
                {
                    ...
                    uiPurchaseButton.Visibility = Visibility.Visible;
                };
            }
#endif
            this.Loaded += (s, e) =>
