...
{
    public sealed partial class ConversionsWeightControl : UserControl, IInitializeCalculator
    {
        public ConversionsWeightControl()
        {
        ...
        public void Initialize(SimpleCalculator simpleCalculator)
        {
            ...
            Loaded += (s, e) =>
            {
                solver = new SolverWPFMetro(new WeightSolver(), uiMain.ItemMain as Grid);
            };
        }
