...
{
    public sealed partial class GeometryRightTriangleControl : UserControl, IInitializeCalculator
    {
        public GeometryRightTriangleControl()
        {
        ...
        public void Initialize(SimpleCalculator simpleCalculator)
        {
            ...
            Loaded += (s, e) =>
            {
                solver = new SolverWPFMetro(new GeometryRightTriangleSolver(), uiMain.ItemMain as Grid);
            };
        }
