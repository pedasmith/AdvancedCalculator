...
namespace AdvancedCalculator
{
    public class AreaSolver : SolverINPC
    {
        public AreaSolver()
        {
            ...
            Equations.Add(new Equation("Meters", "Hectacres", () => { return Hectacres * Conversions.SQUARE_METERS_PER_HECTACRE; }));
            Equations.Add(new Equation("Hectacres", "Meters", () => { return Meters / Conversions.SQUARE_METERS_PER_HECTACRE; }));
        ...
        private double _Hectacres = Double.NaN;
        public double Hectacres { get { return _Hectacres; } set { if (value == _Hectacres) return; _Hectacres = value; OnPropertyChanged("Hectacres"); } }
