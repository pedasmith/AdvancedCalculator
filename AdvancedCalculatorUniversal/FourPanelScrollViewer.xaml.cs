...
{
    public sealed partial class FourPanelScrollViewer : UserControl
    {
        ...
        private void SetOrientation(Orientation orientation)
        {
            ...
            //NOTE: consider re-enabling! if (orientation == CurrOrientation) return; // already correct.
