...
{
    public sealed partial class ElectricalEngineeringCapacitorControl : UserControl, IInitializeCalculator
    {
        public ElectricalEngineeringCapacitorControl()
        {
        ...
        public void Initialize(SimpleCalculator simpleCalculator)
        {
            ...
            Loaded += (s, e) =>
            {
                solver = new SolverWPFMetro(new ElectricalEngineeringCapacitorSolver(), uiMain.ItemMain as Grid);
            };
        }
