...
{
    public sealed partial class ElectricalEngineeringResistorControl : UserControl, IInitializeCalculator
    {
        public ElectricalEngineeringResistorControl()
        {
        ...
        public void Initialize(SimpleCalculator simpleCalculator)
        {
            ...
            Loaded += (s, e) =>
            {
                solver = new SolverWPFMetro(new ElectricalEngineeringResistorSolver(), uiMain.ItemMain as Grid);
            };
        }
