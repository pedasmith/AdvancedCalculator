...
{
    public sealed partial class FinancialCAGRControl : UserControl, IInitializeCalculator
    {
        public FinancialCAGRControl()
        {
        ...
        public void Initialize(SimpleCalculator simpleCalculator)
        {
            ...
            Loaded += (s, e) =>
            {
                solver = new SolverWPFMetro(new FinancialCAGRSolver(), uiMain.ItemMain as Grid);
            };
        }
