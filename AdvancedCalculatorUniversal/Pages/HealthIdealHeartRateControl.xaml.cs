...
{
    public sealed partial class HealthIdealHeartRateControl : UserControl, IInitializeCalculator
    {
        public HealthIdealHeartRateControl()
        {
        ...
        public void Initialize(SimpleCalculator simpleCalculator)
        {
            ...
            Loaded += (s, e) =>
            {
                solver = new SolverWPFMetro(new HealthIdealHeartRateSolver(), uiMain.ItemMain as Grid);
            };
        }
