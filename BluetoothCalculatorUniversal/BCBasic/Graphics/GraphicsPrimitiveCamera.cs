...
{
    class GraphicsPrimitiveCamera : GraphicsPrimitiveRectangleShape
    {

        public GraphicsPrimitiveCamera(Canvas uiCanvas, GraphicsState state, double H, double W, double x1, double y1, double x2, double y2)
        ...
        public override string PreferredName { get { return "Camera"; } }
