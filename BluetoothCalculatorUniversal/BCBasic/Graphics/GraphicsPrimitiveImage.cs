...
{
    public class GraphicsPrimitiveImage : GraphicsPrimitiveRectangleShape
    {
        public Image Image { get { return fe as Image; } }
        public GraphicsPrimitiveImage(Canvas uiCanvas, GraphicsState state, double H, double W, double x1, double y1, double x2, double y2)
            : base(uiCanvas, state, H, W, x1, y1, x2, y2)
        {
            // Do the bits that make is a Camera.
        ...
        // Replace the old element (e.g., the Image) with
        // something new (like a camera preview)
        public void SetNewShape (FrameworkElement value)
        {
            var h = fe.Height;
            var w = fe.Width;
        ...
        public override string PreferredName { get { return "Image"; } }
