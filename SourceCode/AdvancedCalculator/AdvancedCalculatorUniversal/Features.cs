...
namespace Shipwreck
{
    class Features
    {
        static bool debug = false; // NOTE: This statement MUST be false for shipping!
        ...
        public static void Init()
        {
            ...
            FullAccessIsActive = true; // IOT version is free 2019-03-08
#if IOT_VERSION_IS_FREE_NOW
            try
            {
