...
{
    public sealed partial class ConversionsEnergyControl : UserControl, IInitializeCalculator
    {
        public ConversionsEnergyControl()
        {
        ...
        public void Initialize(SimpleCalculator simpleCalculator)
        {
            ...
            Loaded += (s, e) =>
            {
                solver = new SolverWPFMetro(new EnergySolver(), uiMain.ItemMain as Grid);
            };
        }
