...
{
    public sealed partial class ConversionsLengthControl : UserControl, IInitializeCalculator
    {
        public ConversionsLengthControl()
        {
        ...
        public void Initialize(SimpleCalculator simpleCalculator)
        {
            ...
            Loaded += (s, e) =>
            {
                solver = new SolverWPFMetro(new LengthSolver(), uiMain.ItemMain as Grid);
            };
        }
