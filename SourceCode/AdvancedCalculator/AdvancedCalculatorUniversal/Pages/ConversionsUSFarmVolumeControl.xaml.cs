...
{
    public sealed partial class ConversionsUSFarmVolumeControl : UserControl, IInitializeCalculator
    {
        public ConversionsUSFarmVolumeControl()
        {
        ...
        public void Initialize(SimpleCalculator simpleCalculator)
        {
            ...
            Loaded += (s, e) =>
            {
                solver = new SolverWPFMetro(new VolumeSolver(), uiMain.ItemMain as Grid);
            };
        }
