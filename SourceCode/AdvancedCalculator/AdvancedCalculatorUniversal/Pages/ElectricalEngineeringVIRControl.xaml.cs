...
{
    public sealed partial class ElectricalEngineeringVIRControl : UserControl, IInitializeCalculator
    {
        public ElectricalEngineeringVIRControl()
        {
        ...
        public void Initialize(SimpleCalculator simpleCalculator)
        {
            ...
            Loaded += (s, e) =>
            {
                solver = new SolverWPFMetro(new ElectricalEngineeringVIRSolver(), uiMain.ItemMain as Grid);
            };
        }
