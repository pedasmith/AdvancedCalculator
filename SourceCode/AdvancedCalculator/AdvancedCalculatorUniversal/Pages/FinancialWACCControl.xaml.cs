...
{
    public sealed partial class FinancialWACCControl : UserControl, IInitializeCalculator
    {
        public FinancialWACCControl()
        {
        ...
        public void Initialize(SimpleCalculator simpleCalculator)
        {
            ...
            Loaded += (s, e) =>
            {
                solver = new SolverWPFMetro(new FinancialWACCSolver(), uiMain.ItemMain as Grid);
            };
        }
