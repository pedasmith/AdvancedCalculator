...
{
    public sealed partial class GeometryCircleControl : UserControl, IInitializeCalculator
    {
        public GeometryCircleControl()
        {
        ...
        public void Initialize(SimpleCalculator simpleCalculator)
        {
            ...
            Loaded += (s, e) =>
            {
                solver = new SolverWPFMetro(new GeometryCircleSolver(), uiMain.ItemMain as Grid);
            };
        }
