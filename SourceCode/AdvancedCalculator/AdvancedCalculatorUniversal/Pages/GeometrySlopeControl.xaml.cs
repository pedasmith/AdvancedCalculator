...
{
    public sealed partial class GeometrySlopeControl : UserControl, IInitializeCalculator
    {
        public GeometrySlopeControl()
        {
        ...
        public void Initialize(SimpleCalculator simpleCalculator)
        {
            ...
            Loaded += (s, e) =>
            {
                solver = new SolverWPFMetro(new GeometrySlopeSolver(), uiMain.ItemMain as Grid);
            };
        }
